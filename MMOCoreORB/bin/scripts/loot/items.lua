...
includeFile("items/crystal_sunriders_destiny")
includeFile("items/crystal_mauls_vengence")
includeFile("items/crystal_kuns_blood")
includeFile("items/crystal_bondaras_folly")
includeFile("items/crystal_ulics_redemption")
includeFile("items/crystal_banes_heart")
includeFile("items/crystal_gallias_intuition")
includeFile("items/crystal_prowess_of_plo_koon")
includeFile("items/crystal_bnars_sacrifice")
includeFile("items/crystal_windus_guile")
includeFile("items/crystal_mundis_response")
includeFile("items/crystal_strength_of_luminara")
includeFile("items/crystal_baass_wisdom")
includeFile("items/crystal_quintessence_of_the_force")
includeFile("items/crystal_dawn_of_dagobah")
includeFile("items/crystal_horns_future")
includeFile("items/crystal_quigons_devotion")
includeFile("items/crystal_kenobis_legacy")
includeFile("items/crystal_kits_ferocity")
